...
import com.kivi.remote.upnp.org.droidupnp.model.cling.UpnpService;
import com.kivi.remote.upnp.org.droidupnp.model.cling.UpnpServiceController;
...
public class ServiceController extends UpnpServiceController {
    ...
    public void pause() {
        super.pause();
        context.unbindService(upnpServiceListener.getServiceConnexion());
    }
    ...
    public void resume() {
        ...
        context.bindService(new Intent(context, UpnpService.class), upnpServiceListener.getServiceConnexion(),
