...
package com.kivi.remote.upnp.org.droidupnp.model.cling;

import com.kivi.remote.upnp.org.droidupnp.model.upnp.ARendererState;
...
public class RendererState extends ARendererState {
    ...
    public void setPositionInfo(PositionInfo positionInfo) {
        try {
            ...
            Timber.e(e, (e.getMessage() == null) ? "Ëxception !" : e.getMessage());
            for (StackTraceElement m : e.getStackTrace())
                Timber.e(e, m.toString());
        }
    ...
    public String toString() {
        return "RendererState [state=" + state + ", mute=" + volume + ", repeatMode=" + repeatMode + ", randomMode="
