...
public class InputSourceHelper {
    ...
    public enum INPUT_PORT {
        ...
        INPUT_SOURCE_HDMI(23, "hdmi", R.string.hdmi, R.drawable.ic_hdmi, 85, Constants.SOURCE_HDMI1, Constants.SOURCE_HDMI3),//ic_settings_input_hdmi_24dp
        INPUT_SOURCE_HDMI2(24, "hdmi2", R.string.hdmi2, R.drawable.ic_hdmi, 84, Constants.SOURCE_HDMI2),//ic_settings_input_hdmi_24dp
        INPUT_SOURCE_HDMI3(25, "hdmi3", R.string.hdmi3, R.drawable.ic_hdmi, 83, Constants.SOURCE_HDMI3, Constants.SOURCE_HDMI1),//ic_settings_input_hdmi_24dp
        INPUT_SOURCE_HDMI4(26, "hdmi4", R.string.hdmi4, R.drawable.ic_hdmi, 82),//ic_settings_input_hdmi_24dp
        INPUT_SOURCE_HDMI_MAX(27, "hdmi_max", R.string.app_name, R.drawable.ic_hdmi, 81),//ic_settings_input_hdmi_24dp
        ...
        INPUT_SOURCE_KTV(35, "ktv", R.string.app_name, R.drawable.ic_tv, 10),
        INPUT_SOURCE_JPEG(36, "jpeg", R.string.app_name, R.drawable.ic_av, 10),
        INPUT_SOURCE_DTV2(37, "dtv2", R.string.app_name, R.drawable.ic_tv, 10),
        ...
        INPUT_SOURCE_NONE(44, "none", R.string.app_name, R.drawable.ic_tv, 10),
